...
<body>
    <div class="topnav">
        ...
        <a href="../cart/cart.php"><i class="fa fa-shopping-cart" style="font-size:30px;"></i></a>
        </div>
    </div>
   

    <center>
        <div class="MMname">Categories</div>
    </center>
    <div class="Mcategory">
        <div><a href="hiphop.php"><img src="images/hiphop.jpg"></a></div> 
        <div><a href="rock.php"><img src="images/rock.jpg"></a></div>
        <div><a href="classic.php"><img src="images/classic.jpg"></a></div>
    </div>

    <form method="GET" action="music.php" class="search" >
