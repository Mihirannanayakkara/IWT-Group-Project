...
<br><br><br>
  ...
  <hr style="border:1px solid; background-color:#8a7b6d; border-color:#3B3131;">
    ...
    <center><h1 class="topic" style="font-size: 40px;">Add Movie</h1><br>
  
    <form action="Updatemovie.php" method="post" autocomplete="off" enctype="multipart/form-data">
    <input type="hidden" value="<?php echo $id; ?>" name="id">
        ...
        <input type="number" name="price" step="0.01" min="0" value="<?php echo "$price" ?>" required><br>
