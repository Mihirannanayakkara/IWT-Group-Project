<?php
    ...
    if(isset($_POST["upload"])){
       ...
       if($picture==""){
        ...
        window.location.replace('Movieform.php');</script>";
        exit();
       }
       elseif(($type=="image/jpeg") || ($type=="image/jpg") || ($type=="image/png")){
        ...
        $sql="INSERT INTO movie(MovieID,Name,Picture,Category,Price,Description) values('','$name','$picture','$category','$price','$description')";
...
<br><br><br>
  ...
  <hr style="border:1px solid; background-color:#8a7b6d; border-color:#3B3131;">
    ...
    <center><h1 class="topic" style="font-size: 40px;">Add Movie</h1><br><br><br>
