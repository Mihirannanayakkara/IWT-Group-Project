...
if (!empty($searchKeyword)) {
    $sql .= " WHERE email LIKE '%$searchKeyword%'";
}
...
<div id="main-content" class="container allContent-section py-4">
    <div >
      <center>
        <h2 class="cusmuscmov"><i class="fa fa-users" style="font-size:80px"></i> Customers</h2><br><br>
        <div class="sea">
        <form method="GET" action="Admindash.php" class="search">
            <input type="text" name="search" placeholder="Search By User Email...">
          ...
          <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='javascript:void(0);' onclick='confirmDelete(\"" . $row["user_id"] . "\");'><i class='fa fa-trash'></i></a></td>";
                    echo "</tr>";
        ...
        <div class="pagination">
            <?php
            $totalCountQuery = "SELECT COUNT(*) AS total FROM registereduser";
            ...
            for ($i = 1; $i <= $totalPages; $i++) {
                ...
                echo "<a href='Admindash.php?page=$i' class='$isActive'>$i</a>";
            }
            ?>
        </div>
        <script>
            function confirmDelete(userid) {
                if (confirm('Are you sure you want to delete this record?')) {
                    window.location.href = 'Deletecustomer.php?id=' + userid;
                }
            }
        </script>
    </center>
...
<div class="sidebar" id="mySidebar">
  ...
  <hr style="border:1px solid; background-color:#8a7b6d; border-color:#3B3131;">
      ...
      <a href="#"  ><i class="fa fa-users"></i> Customers</a><br>
